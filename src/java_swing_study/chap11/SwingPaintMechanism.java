...
public class SwingPaintMechanism extends JFrame implements ChangeListener, ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SwingPaintMechanism frame = new SwingPaintMechanism();
